...
public interface TeamRepository extends JpaRepository<CFLTeam, Integer> {
	...
	@Query(value = "SELECT id,team_owner,team_name,team_today_score,team_user,team_enabled,team_score,team_current_score,team_modified,team_creation_date,team_last_modified,team_substitution_left, ranks FROM cfl_team WHERE team_owner = ?1", nativeQuery = true)
	...
	List<CFLTeam> findAllActiveTeam();

	@Query(value = "SELECT id,team_owner,team_name,team_user,team_enabled,team_today_score,team_score,team_current_score,team_modified,team_creation_date,team_last_modified,team_substitution_left, RANK() OVER(ORDER BY team_current_score DESC) ranks FROM cfl_team ORDER BY ranks", nativeQuery = true)
